...
// all the imports required for menu after RightClicking
import {
    ContextMenu,
    ContextMenuContent,
    ContextMenuItem,
...
const Live = ({ canvasref, undo, redo }: Props) => {
    ...
    const handleContextMentClick = useCallback((key: string) => {
        switch(key) {
            case 'Chat':
                setCursorState({
                    mode: CursorMode.Chat,
    ...
    return (
        ...
        <ContextMenu>
            ...
            <ContextMenuContent className="right-menu-content">
                ...
                {shortcuts.map((item) => (
                    <ContextMenuItem key={item.key} onClick={() => handleContextMentClick(item.name)}
